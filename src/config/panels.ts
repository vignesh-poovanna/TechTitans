...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  // ---- Hidden panels (not deleted, just hidden) ----
  politics: { name: 'Politics', enabled: false, priority: 2 },
  ...
  commodities: { name: 'Commodities', enabled: false, priority: 2 },
  polymarket: { name: 'Predictions', enabled: false, priority: 2 },
  gov: { name: 'Government', enabled: false, priority: 2 },
  crypto: { name: 'Crypto', enabled: false, priority: 2 },
  middleeast: { name: 'Middle East', enabled: false, priority: 2 },
  layoffs: { name: 'Layoffs', enabled: false, priority: 2 },
  ai: { name: 'AI/ML', enabled: false, priority: 2 },
  startups: { name: 'Startups', enabled: false, priority: 2 },
  vcblogs: { name: 'VC Insights', enabled: false, priority: 2 },
  regionalStartups: { name: 'Global Startups', enabled: false, priority: 2 },
  unicorns: { name: 'Unicorns', enabled: false, priority: 2 },
  accelerators: { name: 'Accelerators', enabled: false, priority: 2 },
  funding: { name: 'Funding', enabled: false, priority: 2 },
  producthunt: { name: 'Product Hunt', enabled: false, priority: 2 },
  security: { name: 'Cybersecurity', enabled: false, priority: 2 },
  policy: { name: 'AI Policy', enabled: false, priority: 2 },
  hardware: { name: 'Hardware', enabled: false, priority: 2 },
  cloud: { name: 'Cloud', enabled: false, priority: 2 },
  dev: { name: 'Developer', enabled: false, priority: 2 },
  github: { name: 'GitHub', enabled: false, priority: 2 },
  ipo: { name: 'IPO', enabled: false, priority: 2 },
  thinktanks: { name: 'Think Tanks', enabled: false, priority: 2 },
  economic: { name: 'Economic', enabled: false, priority: 2 },
  'trade-policy': { name: 'Trade Policy', enabled: false, priority: 2 },
  'supply-chain': { name: 'Supply Chain', enabled: false, priority: 2 },
  africa: { name: 'Africa', enabled: false, priority: 2 },
  latam: { name: 'Latin America', enabled: false, priority: 2 },
  asia: { name: 'Asia', enabled: false, priority: 2 },
  energy: { name: 'Energy', enabled: false, priority: 2 },
  cascade: { name: 'Cascade', enabled: false, priority: 2 },
  'satellite-fires': { name: 'Satellite Fires', enabled: false, priority: 2 },
  'strategic-risk': { name: 'Strategic Risk', enabled: false, priority: 2 },
  'strategic-posture': { name: 'Strategic Posture', enabled: false, priority: 2 },
  'ucdp-events': { name: 'UCDP Events', enabled: false, priority: 2 },
  displacement: { name: 'Displacement', enabled: false, priority: 2 },
  climate: { name: 'Climate', enabled: false, priority: 2 },
  ...
  'oref-sirens': { name: 'Oref Sirens', enabled: false, priority: 2 },
  'telegram-intel': { name: 'Telegram Intel', enabled: false, priority: 2 },
  'world-clock': { name: 'World Clock', enabled: false, priority: 2 },
  'airline-intel': { name: 'Airline Intel', enabled: false, priority: 2 },
  events: { name: 'Events', enabled: false, priority: 2 },
  'service-status': { name: 'Service Status', enabled: false, priority: 2 },
  'tech-readiness': { name: 'Tech Readiness', enabled: false, priority: 2 },
  'macro-signals': { name: 'Market Radar', enabled: false, priority: 2 },
  'etf-flows': { name: 'ETF Flows', enabled: false, priority: 2 },
  stablecoins: { name: 'Stablecoins', enabled: false, priority: 2 },
  'runtime-config': { name: 'Runtime Config', enabled: false, priority: 2 },
  giving: { name: 'Giving', enabled: false, priority: 2 },
  'gulf-economies': { name: 'Gulf Economies', enabled: false, priority: 2 },
  deduction: { name: 'Deduction', enabled: false, priority: 2 },
};
